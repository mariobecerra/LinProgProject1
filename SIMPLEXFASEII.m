...
while(ban==2)
    ...
    if (sum(c>0) > 0)
        ...
        if(sum(l < 0))
            ...
            A([1:l-1 l+1:m], [1:k-1 k+1:n]) = A([1:l-1 l+1:m], [1:k-1 k+1:n]) - A(l,[1:k-1 k+1:n])*A([1:l-1 l+1:m],k)/A(l,k); %Actualizar aij pa todo j No básico menos k y todo i Básica menos l
